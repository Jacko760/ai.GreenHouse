...
public class GoogleLensActivity extends AppCompatActivity {
    ...
    private ImageButton snap, searchResultsBtn;
    private Bitmap imageBitmap;
    private RecyclerView resultRV;
    private Adapter searchResultsRVAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img1=findViewById(R.id.uppl);
        snap = (ImageButton) findViewById(R.id.ivOpenCamera);
        searchResultsBtn = (ImageButton) findViewById(R.id.ivGetResult);
        resultRV = findViewById(R.id.idRVSearchResults);
        dataModalArrayList = new ArrayList<>();
        searchResultsRVAdapter = new Adapter(dataModalArrayList, GoogleLensActivity.this);
        LinearLayoutManager manager = new LinearLayoutManager(GoogleLensActivity.this, LinearLayoutManager.HORIZONTAL, false);
    ...
    private void getResults() {
        ...
        labeler.processImage(image).addOnSuccessListener(new OnSuccessListener<List<FirebaseVisionImageLabel>>() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(GoogleLensActivity.this, "Fail to detect image..", Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void searchData(String searchQuery) {
        String apiKey = "16378a709c05367808d613e717300114f1993a587f774fa0386305b4348ecc5f";
        ...
        RequestQueue queue = Volley.newRequestQueue(GoogleLensActivity.this);
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 0; i < organicResultsArray.length(); i++) {
                        ...
                        dataModalArrayList.add(new model(title, link, displayed_link, snippet));
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                // displaying error message.
                Toast.makeText(GoogleLensActivity.this, "No Result found for the search query..", Toast.LENGTH_SHORT).show();
            }
        });
